...
- A vanilla `ResourceSizeTable.srsizetable` file.\
Download (by game version): <a href="/downloads/ResourceSizeTable.srsizetable" download>v2.0.6 - v2.0.8</a> | <a href="/downloads/ResourceSizeTable_3_0.srsizetable" download>v3.0</a>.
