...
- Message
    - String_XXyy.sarc.zs where XXyy is the language (e.g. USen)
    - TalkSys_XXyy.sarc.zs where XXyy is the language (e.g. USen)
- Model
...
This file links your villager to an Amiibo.

--**Manual Method:**  
- `NumberID`: Matches the `UniqueID` from above
- `NPCLabel`: Your villager's label (e.g., `wol13`)
- Copy other columns from a similar villager
