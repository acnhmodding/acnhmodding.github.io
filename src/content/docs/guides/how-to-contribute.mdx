    ...
    <TabItem label="Locally">
      ...
      <Steps>
        1. Open your terminal and navigate to the directory where you want to clone the repository\
            You can simply _`Shift + Right-Click` in the desired folder and select `Open in Terminal`._
...
If you want to add images to your guide, install the [Markdown Image](https://marketplace.visualstudio.com/items?itemName=hancel.markdown-image) extension (should appear on the recommended extensions) and simply use **Alt + Shift + V** to insert an image. 
